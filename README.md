# End-to-End Graph AML System & Model Risk Governance Framework

**One-liner:** Use graph structure + ML for AML alerting, and validate it with **Model Risk Management (MRM)** so it is deployable, auditable, and operable.
